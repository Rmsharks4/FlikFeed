package com.thecoloredcolors.rmsha.flikfeed.core.chat;
...
import com.thecoloredcolors.rmsha.flikfeed.fcm.FcmNotificationBuilder;
...
public class ChatInteractor implements ChatContract.Interactor {
    ...
    public void sendMessageToFirebaseUser(final Context context, final Chat chat, final String receiverFirebaseToken) {
        //final String room_type_1 = chat.SENDER2.getUsername() + "_" + chat.RECEIVER2.getUsername();
        //final String room_type_2 = chat.RECEIVER2.getUsername() + "_" + chat.SENDER2.getUsername();
        ...
        databaseReference.child(Constants.ARG_CHAT_ROOMS).getRef().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(room_type_1)) {
                    ...
                    databaseReference.child(Constants.ARG_CHAT_ROOMS).child(room_type_1).child(String.valueOf(chat.timestamp)).setValue(chat);
                    //getMessageFromFirebaseUser(chat.SENDER2.getUsername(), chat.RECEIVER2.getUsername());
