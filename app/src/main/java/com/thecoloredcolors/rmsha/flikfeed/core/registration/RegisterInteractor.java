package com.thecoloredcolors.rmsha.flikfeed.core.registration;
...
public class RegisterInteractor implements RegisterContract.Interactor {
    ...
    @Override
    public void performFirebaseRegistration(Activity activity, final String userid, String password) {
