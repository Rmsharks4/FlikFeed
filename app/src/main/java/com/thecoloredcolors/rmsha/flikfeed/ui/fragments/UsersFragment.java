package com.thecoloredcolors.rmsha.flikfeed.ui.fragments;
...
import com.thecoloredcolors.rmsha.flikfeed.core.users.getall.GetUsersContract;
import com.thecoloredcolors.rmsha.flikfeed.core.users.getall.GetUsersPresenter;
import com.thecoloredcolors.rmsha.flikfeed.models.User;
import com.thecoloredcolors.rmsha.flikfeed.ui.activities.ChatActivity;
import com.thecoloredcolors.rmsha.flikfeed.ui.adapters.UserListingRecyclerAdapter;
import com.thecoloredcolors.rmsha.flikfeed.utils.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    @Override
    public void onGetChatUsersSuccess(List<UserProxy> users) {
